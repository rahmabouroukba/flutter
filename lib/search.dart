...
class _searchState extends State<search> {
  ...
  Future<List<String>> uploadFiles(
      File file, File file2, File file3, File file4, File file5) async {
    List<String> ids = [];
    ...
    // ignore: unnecessary_null_comparison
    if (file5 != null) {
      String fileName5 = Path.basename(file5.path);
      Reference ref5 = storage.ref().child("images/$fileName5");
      UploadTask uploadTask5 = ref5.putFile(file5);
      TaskSnapshot taskSnapshot5 = await uploadTask5;
      String id5 = taskSnapshot5.ref.name;
      ids.add(id5);
    }
                      ...
                      Row(
                        children: [
                          Column(
                            children: [
                              Text(
                                " Entre Copie conforme du Contrat de Vente",
                                style: TextStyle(
                                    color: Color.fromARGB(255, 129, 72, 113),
                                    fontSize: 14,
                                    decoration: TextDecoration.underline,
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "  Entre une copie Autorisation de Bâtir",
                                  style: TextStyle(
                                      color: Color.fromARGB(255, 129, 72, 113),
                                      fontSize: 15,
                                      decoration: TextDecoration.underline,
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "  Entre une copie Extrait du plan d'aménagement joint à l'autorisation de bâtir",
                                  style: TextStyle(
                                      color: Color.fromARGB(255, 129, 72, 113),
                                      fontSize: 15,
                                      decoration: TextDecoration.underline,
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "  Entre une copie de la patente et du registre de commerce pour tout usage commercia",
                                  style: TextStyle(
                                      color: Color.fromARGB(255, 129, 72, 113),
                                      fontSize: 15,
                                      decoration: TextDecoration.underline,
                            ...
                            onPressed: () async {
                              if (_formKey.currentState!.validate()) {
                                if (_nomController.text.isNotEmpty &&
                                  ...
                                  String id5 = ids.length > 4 ? ids[4] : '';

                                  await firestore
                                      .collection('demandes')
                                      .doc('nouveau electricitr')
                                      .collection('cas proprietaire')
                                      .add({
                                    'id1': id1,
                                    'id2': id2,
                                    'id3': id3,
